...
SET W5=%SCHEMADIR%\interactions\GetUnitInformationInteraction\GetUnitInformationInteraction_1.0_RIVTABP21.wsdl
SET X5=%SCHEMADIR%\interactions\GetUnitInformationInteraction\*.xsd
