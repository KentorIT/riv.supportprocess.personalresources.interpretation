...
SET W1=%SCHEMADIR%\interactions\GetUnitInformationInteraction\GetUnitInformationInteraction_1.0_RIVTABP21.wsdl
SET X1=%SCHEMADIR%\interactions\GetUnitInformationInteraction\*.xsd
